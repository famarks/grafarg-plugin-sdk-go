...
// Info See also PluginBuildInfo in https://github.com/famarks/grafarg/blob/master/pkg/plugins/models.go
type Info struct {
...
func (v Info) appendFlags(flags map[string]string) {
	...
	if err == nil {
		flags["github.com/famarks/grafarg-plugin-sdk-go/build.buildInfoJSON"] = string(out)
	}
}
...
// -X `github.com/famarks/grafarg-plugin-sdk-go/build.buildInfoJSON={...}`
