...
func TestHARStorage(t *testing.T) {
	...
	t.Run("Load", func(t *testing.T) {
		t.Run("should load the HAR from disk", func(t *testing.T) {
			...
			require.Equal(t, "https://grafarg.com/api/plugins", req.URL.String())
			...
			require.Equal(t, "https://grafarg.com/favicon.ico", req.URL.String())
	...
	t.Run("Delete", func(t *testing.T) {
		t.Run("should delete second entry", func(t *testing.T) {
			...
			require.Equal(t, "https://grafarg.com/api/plugins", s.Entries()[0].Request.URL.String())
		})
	})
