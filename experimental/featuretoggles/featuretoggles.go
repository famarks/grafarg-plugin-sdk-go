...
// FeatureToggles can check if feature toggles are enabled on the Grafarg instance.
...
// It contains the same feature toggles as the Grafarg instance where the plugin is running.
