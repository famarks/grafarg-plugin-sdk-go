...
//
// The Frame object represents a Grafarg Dataframe which can represent data such as tables
// and time series.
//
// Frames can be encoded using Apache Arrow (https://arrow.apache.org/) for transmission.
//
// The corresponding Grafarg frontend package the @grafarg/data package
// (https://github.com/famarks/grafarg/tree/master/packages/grafarg-data).
package data
