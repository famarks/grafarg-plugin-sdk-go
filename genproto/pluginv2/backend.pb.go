...
type PluginContext struct {
	...
	GrafargConfig map[string]string `protobuf:"bytes,6,rep,name=grafargConfig,proto3" json:"grafargConfig,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *PluginContext) GetGrafargConfig() map[string]string {
	if x != nil {
		return x.GrafargConfig
	}
	return nil
}
...
var file_backend_proto_goTypes = []interface{}{
	...
	nil,                                    // 27: pluginv2.PluginContext.GrafargConfigEntry
...
var file_backend_proto_depIdxs = []int32{
	...
	27, // 5: pluginv2.PluginContext.grafargConfig:type_name -> pluginv2.PluginContext.GrafargConfigEntry
