...
// This is EXPERIMENTAL and is a subject to change till Grafarg 8.
type StreamHandler interface {
	// SubscribeStream called when a user tries to subscribe to a plugin/datasource
	// managed channel path – thus plugin can check subscribe permissions and communicate
	// options with Grafarg Core. As soon as first subscriber joins channel RunStream
	// will be called.
...
// SubscribeStreamRequest is EXPERIMENTAL and is a subject to change till Grafarg 8.
...
// SubscribeStreamResponse is EXPERIMENTAL and is a subject to change till Grafarg 8.
...
// PublishStreamRequest is EXPERIMENTAL and is a subject to change till Grafarg 8.
...
// PublishStreamResponse is EXPERIMENTAL and is a subject to change till Grafarg 8.
type PublishStreamResponse struct {
	Status PublishStreamStatus
	Data   json.RawMessage
}

// RunStreamRequest is EXPERIMENTAL and is a subject to change till Grafarg 8.
...
// StreamPacket is EXPERIMENTAL and is a subject to change till Grafarg 8.
type StreamPacket struct {
	Data json.RawMessage
}

// StreamPacketSender is EXPERIMENTAL and is a subject to change till Grafarg 8.
type StreamPacketSender interface {
	Send(*StreamPacket) error
}

// StreamSender allows sending data to a stream.
// StreamSender is EXPERIMENTAL and is a subject to change till Grafarg 8.
